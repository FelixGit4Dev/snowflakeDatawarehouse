...
@Entity
@Table(name="SALESPERSON_MAP")
public class SalesPerson_MAP implements Serializable{
	...
	public SalesPerson_MAP() {
		super();
		// TODO Auto-generated constructor stub
	}

	public SalesPerson_MAP(long sourceKey, long dwhKey, Timestamp modifiedDate, Timestamp from, Time to) {
		super();
		this.sourceKey = sourceKey;
		this.dwhKey = dwhKey;
		this.modifiedDate = modifiedDate;
