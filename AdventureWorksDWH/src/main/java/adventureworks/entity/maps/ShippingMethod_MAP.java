...
@Entity
@Table(name="SHIPPINGMETHOD_MAP")
public class ShippingMethod_MAP implements Serializable{
	...
	public ShippingMethod_MAP(long sourceKey, long dwhKey, Timestamp modifiedDate, Timestamp from, Time to) {
		super();
