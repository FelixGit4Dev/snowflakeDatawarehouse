...
@Entity
@Table(name="CUSTOMER_MAP")
public class Customer_MAP  implements Serializable{
...
public Customer_MAP(long sourceKey, long dwhKey, Timestamp modifiedDate, Timestamp from, Timestamp to) {
	super();
